...
clear_day = ['113']
fog = ['260', '248', '143']
snow = ['395', '392', '377', '374', '371', '368', '350', '338', '335', '332', '329', '326', '323', '230', '227', '179']
sleet = ['365', '362', '320', '317', '284', '281', '185', '182']
rain = ['389', '386', '359', '356', '353', '314', '311', '308', '305', '302', '299', '296', '293', '266', '263', '200', '176']
    ...
    <div class="menu-box">
        ...
        <main>
          <div>
              ...
              <form action="/make_changes" method="POST">
                Pump Start Time<br>
...
def get_weather_loop():
    ...
    day4_graphic, day5_day, day5_graphic, day1_max_temp, day1_min_temp, day2_max_temp, day2_min_temp, \
    day3_max_temp, day3_min_temp, day4_max_temp, day4_min_temp, day5_max_temp, day5_min_temp, current_date, \
    day1_conditions, day2_conditions, day3_conditions, day4_conditions, day5_conditions, ordinal
    ...
    while True:
        try:
            ...
            dt_sunrise_in = datetime.strptime(day1_sunrise, "%I:%M %p")
            sunrise = datetime.strftime(dt_sunrise_in, "%H:%M")
            dt_sunset_in = datetime.strptime(day1_sunset, "%I:%M %p")
            sunset = datetime.strftime(dt_sunset_in, "%H:%M")
...
def current_variable_status():
    ...
    day4_graphic, day5_day, day5_graphic, day1_max_temp, day1_min_temp, day2_max_temp, day2_min_temp, \
    day3_max_temp, day3_min_temp, day4_max_temp, day4_min_temp, day5_max_temp, day5_min_temp, current_date, \
    day1_conditions, day2_conditions, day3_conditions, day4_conditions, day5_conditions, ordinal, pump_hour, sweeper_hour, sweeper_duration
...
t1 = Thread(target = get_weather_loop)
t2 = Thread(target = read_water_pressure)
t3 = Thread(target = read_monitor_starting_pressure)
t4 = Thread(target = run_web_server)
# t5 = Thread(target = current_variable_status)
t1.start()
t2.start()
t3.start()
t4.start()
